...
namespace AMEC.PCSoftware.CommunicationProtocol.CrazyHein.OrbmentDAQ.Storage
{
    ...
    {
        private AcquisitionUnitState __state = AcquisitionUnitState.Idle;
        ...
        private string __exception_message = "";
