...
{
    [ArithmeticUnitUsage("INRANGE(min, max, v0, v1, ...): Returns 1 when all the entered variables(v0, v1, ...) are in the specified range([min, max]), and 0 in other cases.")]
    ...
    [ArithmeticUnitUsage("DIFF(v0, ...): Returns the calculation result of MAX(v0, ...) - MIN(v0, ...).")]
